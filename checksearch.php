      ...
      <div class="w3-col s8">
        <table class="w3-table w3-striped w3-hoverable w3-bordered w3-border w3-white w3-medium" >
          ...
          <tr>
            ...
            <td>
              <a href="patient_details.php?id=<?php echo $uid; ?>" style="" class=""><i class="fa fa-external-link-square"></i>&nbsp;View</a>    
            </td>
              <td>
              <a href="remove.php?id=<?php echo $uid; ?>" style="" class=""><i class="fa fa-external-link-square"></i>&nbsp;Delete</a>    
            </td>
            <td>
              <a href="Checkout.php?id=<?php echo $uid; ?>" style="" class=""><i class="fa fa-external-link-square"></i>&nbsp;Checkout</a>    
            </td>
          </tr>
